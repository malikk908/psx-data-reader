...
def main():
    ...
    if success:
        print("\nData has been successfully stored in MongoDB with the following schema:")
        print("""
{
    "_id": ObjectId("..."),
    "symbol": "MEBL", 
...
db.stock_data.find({ "symbol": "MEBL" })

# Get data for a specific date
db.stock_data.find({ "symbol": "MEBL", "date": ISODate("2025-08-01T00:00:00Z") })
